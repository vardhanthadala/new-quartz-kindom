      ...
      >
        <div className="max-w-[1800px] mx-auto flex items-center justify-between px-6 sm:px-8 lg:px-12 xl:px-16 h-16 sm:h-20 relative z-50">
          ...
          <button
            ...
            className={`flex flex-col justify-center items-center gap-[6px] w-10 h-10 md:hidden transition-transform active:scale-90 bg-white/10 backdrop-blur-sm border border-white/20 rounded-lg relative z-[60] ${menuOpen ? "hamburger-open" : ""}`}
          >
